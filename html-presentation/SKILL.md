...
**Always build directly in the main context** — do not delegate HTML generation to a subagent. Before writing any HTML, read ALL FIVE reference files. This is mandatory — skipping any file will cause structural errors that require significant rework:
